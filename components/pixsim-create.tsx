              ...
              <>
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {hairLabels.map((label, i) => (
                      <button
                        key={i}
                        type="button"
                        onClick={() => updateChar("hair", i as 0 | 1 | 2 | 3)}
                    ...
                    {eyeColors.map((opt) => (
                      ...
                      >
                        <div
                          ...
                          style={{ backgroundColor: opt.value, boxShadow: `0 1px 4px ${opt.value}60` }}
                        />
                        <span className="text-[7px] font-semibold uppercase tracking-wider text-primary/60">
                          {opt.label}
                        </span>
                      </button>
                    ))}
