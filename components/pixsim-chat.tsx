  ...
  return (
    <div className="relative mt-5">
      ...
      <div className="mb-3 flex items-center gap-2">
        <div className="h-px flex-1" style={{ background: "rgba(200,220,255,0.3)" }} />
      ...
      <div
        ...
        style={{
          background: "linear-gradient(180deg, rgba(230,242,255,0.4), rgba(230,242,255,0.4))",
      ...
      >
        ...
        <div className="flex gap-2 p-3" style={{ borderTop: "1px solid rgba(200,220,255,0.3)" }}>
          <input
            ...
            onBlur={(e) => {
              e.currentTarget.style.borderColor = "rgba(200,220,255,0.4)"
